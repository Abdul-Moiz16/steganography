...
\setcounter{tocdepth}{2}   % TOC lists sections + subsections only
% Bare TOC body (no auto "Contents" heading); defined here where @ is a letter
% so it can be called from inside the \twocolumn[...] title block.
\makeatletter
\newcommand{\barecontents}{\@starttoc{toc}}
\makeatother
\DeclareRobustCommand{\by}[1]{\textnormal{\normalfont\footnotesize\space--- #1}}
...
\end{center}
\vspace{0.7cm}
% Table of contents: full-width, balanced two columns, on the title page.
% A \clearpage after the front matter starts the body (Introduction) on page 2.
{\centering\small\bfseries\scshape Contents\par}
\vspace{0.25cm}
{\small
...
% ============================================================
\section[Introduction\by{\textbf{Writer:} Nico Müller-Späth  \textbf{Reviewer:} David Wicker  \textbf{Contributor:}  Abdul Moiz Akbar}]{Introduction}
\label{sec:intro}
% ============================================================
...
% ============================================================
\section[Related Work\by{\textbf{Writer:} Abdul Moiz Akbar  \textbf{Reviewer:} Daria \textbf{Contributor:}  Nikolas}]{Related Work}
...
% ============================================================
\section[Methodology\by{\textbf{Writer:} David Wicker  \textbf{Reviewer:} Jimena \textbf{Contributor:}  Abdul}]{Methodology}
...
% ============================================================
\section[Experimental Setup\by{\textbf{Writer:} Abdul Moiz Akbar  \textbf{Reviewer:} Daria \textbf{Contributor:}  Nico}]{Experimental Setup }
...
% ============================================================
\section[Classical-Detector\by{\textbf{Writer:} Jimena Narvaez  \textbf{Reviewer:} David \textbf{Contributor:}  Nikolas}]{Classical-Detector}
...
% ============================================================
\section[Learned-Detector Cross-Validation\by{\textbf{Writer:} David Wicker \textbf{Reviewer:} Abdul \textbf{Contributor:}  Daria}]{Methodology}
...
% ============================================================
\section[Detector-Level Contributions\by{\textbf{Writer:} Daria Gjonbalaj \textbf{Reviewer:} Nico \textbf{Contributor:}  Nikolas}]{Detector-Level}
...
% ============================================================
\section[Discussion\by{\textbf{Writer:} Nikolas Zouros \textbf{Reviewer:} Jimena \textbf{Contributor:}  David}]{Discussion}
...
% ============================================================
\section[Limitations\by{\textbf{Writer:} Daria Gjonbalaj  \textbf{Reviewer:} Nico \textbf{Contributor:}  Abdul}]{Methodology}
...
% ============================================================
\section[Conclusion and Future Work\by{\textbf{Writer:} Jimena Narvaez  \textbf{Reviewer:} Daria \textbf{Contributor:}  Nikolas}]{Methodology}
...
% Collapse the appendix in the TOC to a single "Appendix" line. titlesec does
% not honour tocdepth here, so suppress further section-level TOC writes directly.
\makeatletter
