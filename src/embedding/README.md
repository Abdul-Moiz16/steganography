...
- **Frequency branch**: JSteg-style DCT-LSB on non-zero quantized AC coefficients using `jpeglib` pinned to libjpeg 6b, JPEG quality locked to 95, no re-quantization after coefficient edits
